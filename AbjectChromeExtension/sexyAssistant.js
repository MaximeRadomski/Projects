if (localStorage.getItem("AssistantEnable") == "0")
{
  enable();
}
else
...
function enable()
{
  if (document.getElementById("AssistantContainer"))
  {
    if (document.getElementById("AssistantContainer").style.display == "none")
    {
      document.getElementById("AssistantContainer").style.display = "block";
      localStorage.setItem("AssistantEnable", "1");
    }
    else
    {
      disable();
